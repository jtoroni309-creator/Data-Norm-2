...
async def fix_tables():
    ...
    async with engine.begin() as conn:
        ...
        # Recreate signatures table
        print("Recreating signatures table...")
        await conn.execute(text("""
        ...
        # Recreate approvals table
        print("Recreating approvals table...")
        await conn.execute(text("""
        ...
        # Recreate control_objectives table
        print("Recreating control_objectives table...")
        ...
        print("Recreating controls table...")
        await conn.execute(text("""
        ...
        # Recreate test_plans table
        print("Recreating test_plans table...")
        await conn.execute(text("""
